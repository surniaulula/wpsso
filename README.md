<h1>WPSSO Core - The Complete Structured Data Plugin: Schema Markup and Meta Tags for Social and SEO</h1>
...
<tr><th align="right" valign="top" nowrap>Stable Version</th><td>15.5.0</td></tr>
...
<blockquote>
  <p><strong>Looking to fix the Google Merchant "<em>Price Mismatched value</em>" error for WooCommerce product variations?</strong></p>
  
  <p>The WPSSO Core plugin fixes the "<em>Price Mismatched value</em>" error and all other Google Search, Google Rich Results, and Google Merchant errors for WooCommerce products.</p>
</blockquote>
