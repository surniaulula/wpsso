...
<p>Integrates with WordPress posts/pages, custom post types, users/profiles, terms (categories and tags), and settings editing pages using a the WordPress <em>look and feel</em>.</p>
