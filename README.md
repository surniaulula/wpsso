...
<tr><th align="right" valign="top" nowrap>Stable Version</th><td>6.2.0</td></tr>
...
<li><p>Customize the Open Graph type "article", "place", "product", or "website" for each individual posts, pages, custom post types, etc.</p></li>
