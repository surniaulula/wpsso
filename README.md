<h1>WPSSO Core</h1><h3>Complete Open Graph, Rich Pin, Twitter Card, SEO Meta Tags and Rich Card / Schema Markup</h3>
...
<tr><th align="right" valign="top" nowrap>Stable Version</th><td>4.25.2</td></tr>
...
<tr><th align="right" valign="top" nowrap>Tags / Keywords</th><td>open graph, pinterest rich pins, twitter cards, google rich cards, schema.org, seo, woocommerce, facebook, twitter, google, pinterest, twitter, linkedin, google merchant, social media, social sharing, meta tags</td></tr>
</table>
...
<p><strong>WPSSO Core makes sure your content looks great on social and search sites -- no matter how URLs are crawled, shared, re-shared, posted, or embedded:</strong></p>

<p>WPSSO Core is fast, simple, and provides <em>complete and accurate</em> information about your webpage content to social sites (Facebook, Pinterest, Twitter, LinkedIn, etc.), search crawlers (Google, Bing, etc.), mail and messaging apps (Facebook Messenger, iMessage, Skype, WhatsApp, etc.), and embedded objects / iframes.</p>
