...
<blockquote>
  <p><strong>Looking to fix the Google Merchant "<em>Price Mismatched value (page crawl): (price [price])</em>" error for WooCommerce product variations?</strong></p>
  
  <p>The WPSSO Core plugin fixes all Google Search, Google Rich Results, and Google Merchant errors for WooCommerce products.</p>
</blockquote>
