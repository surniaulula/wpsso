<h1>WPSSO Core</h1><h3>The Most Advanced Structured Data Plugin for WordPress - JSON-LD, Meta Tags, oEmbed, REST API, Google Rich Results, Rich Pins, Schema, SEO and More</h3>
