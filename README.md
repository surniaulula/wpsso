...
<tr><th align="right" valign="top" nowrap>Stable Version</th><td>6.3.1</td></tr>
...
<p>WPSSO Core provides complete information about your webpage content to social sites (Facebook, Pinterest, Twitter, LinkedIn, etc.), search crawlers (Google, Bing, etc.), mail and messaging apps (Facebook Messenger, iMessage, Skype, WhatsApp, etc.), and embedded objects / iframes (aka oEmbed).</p>
...
<li><p>Updates the WordPress oEmbed response data and HTML markup with the Open Graph title, description, and image.</p></li>
