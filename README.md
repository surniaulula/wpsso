<h1>WPSSO Core</h1><h3>Advanced Structured Data (Meta Tags, oEmbed, REST API, Rich Pins, Rich Results, Schema and More)</h3>
...
<tr><th align="right" valign="top" nowrap>Stable Version</th><td>9.0.1</td></tr>
...
<p>There's no need to create or select templates, manually reenter descriptions, titles, product information, or reselect images and videos. WPSSO can read your existing WordPress content, including custom post types and taxonomies, enhanced user profile data, Media Library image and video information, third-party plugin data, and remote service APIs (Bitly, Facebook, Shopper Approved, Stamped.io, Vimeo, Wistia, YouTube, and many more).</p>
...
<p><strong>[Premium]</strong> Schema JSON-LD markup for WooCommerce Products:</p>
...
<p><strong>[Premium]</strong> Additional customizable Schema options in the Document SSO metabox:</p>
