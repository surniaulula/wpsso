...
<ul>
<li><p>Example meta tags from WPSSO with the <a href="http://wpsso.com/extend/plugins/wpsso-schema-json-ld/">WPSSO JSON Pro</a> extension for Schema JSON-LD markup.</p>
