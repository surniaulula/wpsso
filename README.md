...
<p><strong>Optional Free and Pro extensions</strong> for <em>Mobile App Meta</em> to provide Apple Store / iTunes and Google Play App meta tags, <em>Place / Location and Local Business Meta</em> to provide Pinterest Place, Facebook / Open Graph Location, Schema Local Business + Local SEO meta tags, complete <em>Schema JSON-LD</em> markup (BlogPosting, Article, Place, Product, etc.) for Google and Pinterest, Ridiculously Responsive (SVG) <em>Social Sharing Buttons</em>, and more.</p>
