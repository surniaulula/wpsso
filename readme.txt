...
**Imports plugin metadata and block attributes, including:**
...
**Version 11.4.1-dev.2 (2022/03/02)**
...
* **Developer Notes**
	* Removed unused methods:
		* `WpssoUtil::protect_filter_value()`
		* `WpssoUtil::unprotect_filter_value()`
		* `WpssoUtil::get_original_filter_value()`
...
(2022/03/02) Fixed possible missing site name and tagline values in the Webpage Title Tag filters. Updated the default Twitter Card image dimensions. Added support for a new optional WPSSO_TITLE_TAG_DISABLE constant.
...
(2022/02/19) Added a new Document SSO &gt; Edit Visibility &gt; 301 Redirect URL option. Fixed an incorrect visual element change on mouseover for The Events Calendar and WP Job Manager option selects (Premium edition).

= 11.0.0 =

(2022/02/17) Added a new "SEO Title Tag" option in the Document SSO metabox. Added a new "Truncated Text Ellipsis" option. Added a progress bar to the character counter.
...
(2022/01/27) Added a new "Import Yoast SEO Block Attrs" option (Premium edition). Added detection (and work-around) of incorrect post type archive pages. Fixed incorrect detection of a post object ID 0 as a blog archive page.
...
(2022/01/19) Added new "Import Rank Math SEO Metadata" and "Import SEO Framework Metadata" options. Fixed addition of sameAs URLs for post ID 0. Renamed lib/abstracts/ folder and its classes.
