...
* Built-in compatibility checks for popular SEO plugins (\*\* additional integration features also available in Premium version):
...
* **Improvements**
	* None.
* **Bugfixes**
	* Fixed missing 'article:modified_time' meta tag value.
* **Developer Notes**
	* None.
* **Requires At Least**
	* PHP v7.0.
