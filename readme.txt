=== WPSSO Core - Complete Open Graph, Rich Pin, Twitter Card, SEO Meta Tags and Rich Card / Schema Markup ===
...
Tags: open graph, pinterest rich pins, twitter cards, google rich cards, schema.org, facebook, twitter, google, pinterest, twitter, linkedin, woocommerce, google merchant, seo, meta tags, social media, social sharing
...
WPSSO Core is fast, simple, and provides *complete and accurate* information about your webpage content to social sites (Facebook, Pinterest, Twitter, LinkedIn, etc.), search crawlers (Google, Bing, etc.), mail and messaging apps (Facebook Messenger, iMessage, Skype, WhatsApp, etc.), and embedded objects / iframes.
...
* *Developer Notes*
	* Added a new 'WPSSO_SCHEMA_PRODUCT_VALID_MAX_TIME' constant for the WPSSO JSON add-on (default is 1 year).
...
* *New Features*
	* None.
* *Improvements*
	* Added support for the Pin It button hidden image in WooCommerce archive pages (Pro version).
	* Removed the "Author Link URL Profile Contact" and "Google+ Business Page URL" options (no longer used by Google).
	* The "Product Availability" option in the Document SSO metabox is now disabled automatically if a supported e-commerce plugin is detected (availability is provided by the e-commerce plugin).
* *Bugfixes*
	* None.
* *Developer Notes*
