...
**Version 4.31.0-dev.2 (2019/05/15)**
...
(2019/05/15) Fixed an incorrect method call in the 'wpsso_schema_attributes' function. Fixed an incorrect post status value in WpssoUtil::get_page_url().
