...
**Version 15.22.0-rc.2 (2023/09/01)**
...
(2023/09/01) Added a new SSO &gt; Advanced Settings &gt; Service APIs &gt; Media Services &gt; WordPress Video Blocks option (Premium edition).
...
(2023/08/05) Fixed the WP and PHP recommended version notice dismissal key.
...
(2023/07/15) Added a new "Anchor ID" input field for How-To and Recipe steps. Fixed saving radio button options (ie. the How-To step or section option).
...
(2023/06/19) Added a notice to suggest activating the WPSSO CMCF and MRP add-ons if WooCommerce is active.

= 15.14.0 =

(2023/06/15) Added new options under the SSO &gt; Advanced Settings &gt; Document Types &gt; Schema tab.
...
(2023/06/06) Added a definition for the new WPSSO Merchant Return Policy Manager add-on.

= 15.13.0 =

(2023/06/05) Added a new "Product Return Policy" option in the Document SSO metabox. Updated the WooCommerce shipping destination markup for "Everywhere" to include all countries.
...
(2023/04/22) Added support for WP Meta SEO taxonomy term metadata. Added a new Import WP Meta SEO Metadata option.
...
(2023/04/13) Added automatic display of notices. Fixed the possible incorrect addition of term hierarchy in the breadcrumb title.
...
(2023/02/03) Added support for Schema ProductGroup markup. Fixed potential missing price currency and value units meta tags. Fixed extra min/max energy efficiency meta tags.
