...
1. Shows notices for missing and required images.
1. Verifies webpages for duplicate meta tags.
1. Validates theme header templates for correct HTML markup.
1. Checks and warns of any missing PHP modules.
1. Checks 3rd party plugin settings for possible conflicts.
