...
**Version 18.2.0-dev.2 (2024/08/17)**

* **New Features**
	* None.
* **Improvements**
	* Updated colors for checkbox slider options.
	* Updated the dynamic width of the submit buttons fixed toolbar.
* **Bugfixes**
	* None.
* **Developer Notes**
	* None.
...
* **Bugfixes**
	* None.
* **Developer Notes**
	* Removed deprecated methods from 2023.
* **Requires At Least**
	* PHP v7.2.34.
	* WordPress v5.8.

**Version 17.21.0 (2024/07/31)**
...
* **Developer Notes**
	...
	* Updated `WpssoUtilCache->clear_cache_files()` arguments to add an include and exclude array.
	* Updated `WpssoUtilCache->refresh()` to clear only JS and TXT cache files.
...
* **Improvements**
	* None.
* **Bugfixes**
	* Fixed addition of WooCommerce shipping destinations for zip/postal codes.
* **Developer Notes**
	* None.
* **Requires At Least**
	* PHP v7.2.34.
...
(2024/08/17) Updated colors for checkbox slider options. Updated the dynamic width of the submit buttons fixed toolbar.
