...
**Version 3.51.0-dev.3 (2018/01/25)**
...
* *New Features*
	* None
* *Improvements*
	* Added plugin / extension name and version to the bottom of settings pages.
* *Bugfixes*
...
* *New Features*
	* None
* *Improvements*
	* Changed the maximum "Google Search / SEO Description" length from 160 to 320 characters.
* *Bugfixes*
	* None
* *Developer Notes*
	* Refactored the `esc_url_encode()` method to decode any HTML entities found in the URL.
	* Added an SucomUtil `decode_html()` method to decode HTML entities and UTF8 encoding.
	* Removed old methods deprecated on 2017/09/03 from the SucomForm class.
...
(2018/01/14) Fixed non-static calls to the show_opts() method in WpssoUser (props @legacycode).
...
(2017/12/09) Use sharing URL instead of shortlink when checking for duplicate meta tags if PHP "open_basedir" is defined. Fixed the return value from WpssoProUtilUser get_options() for an invalid user id. Updated the MobileDetect library.
