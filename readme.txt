...
(2018/07/20) Fixed the default / initial order of image and video meta tags. Added an 'og:image:alt' meta tag for images provided by WordPress Media Library. Renamed the 'og:image' meta tag to 'og:image:url'.
