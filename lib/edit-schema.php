			...
			$form_rows = array(
				...
				'schema_howto_steps' => array(
					...
					'content'  => $form->get_mixed_multi( array(
						...
						'schema_howto_step_container_id' => array(
							'input_label' => _x( 'Container ID', 'option label', 'wpsso' ),
							'input_type'  => 'text',
							'input_class' => 'css_id howto_step_container_id',
						),
			...
			$form_rows = array(
				...
				'schema_recipe_instructions' => array(
					...
					'content'  => $form->get_mixed_multi( array(
						...
						'schema_recipe_instruction_container_id' => array(
							'input_label' => _x( 'Container ID', 'option label', 'wpsso' ),
							'input_type'  => 'text',
							'input_class' => 'css_id recipe_instruction_container_id',
						),
