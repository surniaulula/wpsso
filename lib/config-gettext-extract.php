...
_x( 'WPSSO Core add-on to provide a user locale (language / region) drop-down menu in the WordPress admin back-end and front-end toolbar.', 'plugin description', 'wpsso' );
...
_x( 'WPSSO Core add-on to provide Twitter-style quoted text to your content with a Tweet share link and customizable CSS.', 'plugin description', 'wpsso' );
