...
_x( 'Image URL Custom Field', 'option value', 'wpsso' );
...
_x( 'Product Availability Custom Field', 'option value', 'wpsso' );
_x( 'Product Currency Custom Field', 'option value', 'wpsso' );
_x( 'Product Price Custom Field', 'option value', 'wpsso' );
_x( 'Public Holidays', 'option value', 'wpsso' );
_x( 'Recipe Ingredients Custom Field', 'option value', 'wpsso' );
...
_x( 'Video Embed HTML Custom Field', 'option value', 'wpsso' );
_x( 'Video URL Custom Field', 'option value', 'wpsso' );
