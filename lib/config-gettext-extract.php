...
_x( '<color>Extension Plugins and Pro Licenses</color>', 'lib file description', 'wpsso' );
_x( '<color>Plugin Dashboard and Features Status</color>', 'lib file description', 'wpsso' );
