...
_x( '(default)', 'form option value', 'wpsso' );
...
_x( '(no images)', 'form option value', 'wpsso' );
_x( '[none]', 'form option value', 'wpsso' );
_x( '(no videos)', 'form option value', 'wpsso' );
_x( '(option disabled)', 'form option value', 'wpsso' );
_x( 'Read Me', 'lib file description', 'wpsso' );
_x( 'Right', 'form option value', 'wpsso' );
_x( '(settings value)', 'form option value', 'wpsso' );
