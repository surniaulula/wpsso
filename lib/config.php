		...
		public static $cf = array(
			...
			'plugin' => array(
				...
				'wpssojson' => array(
					...
					'desc' => 'WPSSO extension to add complete Schema JSON-LD markup (Article, Product, etc.) for Google and Pinterest.',
			...
			'opt' => array(						// options
				...
				'defaults' => array(
					...
					'add_meta_property_place:type' => 0,
					'add_meta_property_place:street_address' => 1,
					'add_meta_property_place:po_box_number' => 0,
