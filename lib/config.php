		...
		public static $cf = array(
			...
			'plugin' => array(
				'wpsso' => array(			// Plugin acronym.
					'version' => '3.54.1-dev.1',		// Plugin version.
					'opt_version' => '576',		// Increment when changing default option values.
					'short' => 'WPSSO Core',	// Short plugin name.
					'name' => 'WPSSO Core (Main Plugin)',
					'desc' => 'Automatically create complete meta tags + Schema markup from your existing content for Social Sharing / Social Media, Google / SEO, Pinterest Rich Pins + more.',
					'slug' => 'wpsso',
