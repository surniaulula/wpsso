		...
		public static $cf = array(
			...
			'plugin' => array(
				'wpsso' => array(			// Plugin acronym.
					'version'     => '6.6.0',	// Plugin version.
					'opt_version' => '668',		// Increment when changing default option values.
					'short'       => 'WPSSO Core',	// Short plugin name.
					'name'        => 'WPSSO Core',
					'desc'        => 'WPSSO Core is fast, simple, and makes sure your content looks great on all social and search sites - no matter how your URLs are crawled, shared, re-shared, posted, or embedded!',
					'slug'        => 'wpsso',
