		...
		public static $cf = array(
			...
			'plugin' => array(
				'wpsso' => array(			// Plugin acronym.
					'version'     => '15.20.0-dev.2',	// Plugin version.
					'opt_version' => '982',		// Increment when changing default option values.
					...
					'lib' => array(
						'integ' => array(	// Plugin integration modules.
							'data' => array(
								...
								'wpmetaseo-meta'    => '(feature) Import WP Meta SEO Metadata',
			 ...
			 */
			'um' => array(
				'rec_version' => '4.18.0',	// Minimum update manager version (soft limit).
			...
			'wp' => array(
				...
				'rec_version' => '6.2.2',	// Soft limit - issue warning if lower version found.
