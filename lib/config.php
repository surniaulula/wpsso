...
if ( ! class_exists( 'WpssoConfig' ) ) {
	...
	class WpssoConfig {
		...
		public static $cf = array(
			...
			'plugin' => array(
				...
				'wpssowpsm' => array(			// Plugin acronym.
					...
					'desc'        => 'Include Schema images, alternate language URLs, post type archive pages, select post types and taxonomies, exclude "No Index" and redirected pages.',
			...
			'opt' => array(
				'defaults' => array(
					...
					'plugin_cf_product_depth_value'           => '',	// Product Net Depth Custom Field.
				...
				'cf_md_index' => array(
					...
					'plugin_cf_product_depth_value'           => 'product_depth_value',		// Product Net Depth Custom Field.
			 ...
			 */
			'um' => array(
				'rec_version' => '4.13.2',	// Minimum update manager version (soft limit).
				'check_hours' => array(
					24  => 'Every day',
					48  => 'Every two days',
					72  => 'Every three days',
			...
			'head' => array(
				...
				'og_type_mt' => array(
					...
					'product' => array(
						...
						'product:shipping_length:value'     => '',				// Non-standard / internal meta tag.
						'product:shipping_length:units'     => '',				// Non-standard / internal meta tag.
						'product:shipping_height:value'     => '',				// Non-standard / internal meta tag.
						'product:shipping_height:units'     => '',				// Non-standard / internal meta tag.
						'product:shipping_weight:value'     => 'product_shipping_weight_value',
						'product:shipping_weight:units'     => '',
						'product:shipping_width:value'      => '',				// Non-standard / internal meta tag.
						'product:shipping_width:units'      => '',				// Non-standard / internal meta tag.
		...
		public static function get_variable_constants() {
			...
			$var_const[ 'WPSSO_GET_POSTS_MAX_TIME' ]          = 0.30;		// Send error to trigger_error() if get_posts() takes longer.
			$var_const[ 'WPSSO_IMAGE_MAKE_SIZE_MAX_TIME' ]    = 2.00;		// Send error to trigger_error() if image_make_intermediate_size() takes longer.
			$var_const[ 'WPSSO_INLINE_VARS_MAX_DEPTH' ]       = 3;
			$var_const[ 'WPSSO_PHP_GETIMGSIZE_MAX_TIME' ]     = 2.00;		// Send an error to trigger_error() if getimagesize() takes longer.
