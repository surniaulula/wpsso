...
if ( ! class_exists( 'WpssoConfig' ) ) {
	...
	class WpssoConfig {
		...
		public static $cf = array(
			...
			'plugin' => array(
				'wpsso' => array(			// Plugin acronym.
					'version'     => '4.24.2-dev.1',	// Plugin version.
					'opt_version' => '636',		// Increment when changing default option values.
			 ...
			 */
			'um' => array(
				'rec_version' => '1.18.0',	// Minimum update manager version (soft limit).
				'check_hours' => array(
					24  => 'Every day',
					48  => 'Every two days',
					72  => 'Every three days',
		...
		public static function get_variable_constants() {
			...
			$var_const[ 'WPSSO_SCHEMA_PRODUCT_VALID_MAX_TIME' ]  = YEAR_IN_SECONDS * 10;	// Used for default Schema 'priceValidUntil' property.
