		...
		public static $cf = array(
			...
			'plugin' => array(
				'wpsso' => array(			// Plugin acronym.
					'version'     => '4.9.0-rc.2',	// Plugin version.
					'opt_version' => '584',		// Increment when changing default option values.
					'short'       => 'WPSSO Core',	// Short plugin name.
					'name'        => 'WPSSO Core [Main Plugin]',
					'desc'        => 'WPSSO Core gives social sites and search engines more information about your content, business and authors with complete meta tags and Schema markup for social sharing, Google\'s Knowledge Graph / Rich Card SEO, Pinterest Rich Pins, Twitter Cards and more.',
					'slug'        => 'wpsso',
			 ...
			 */
			'um' => array(
				'rec_version' => '1.11.0-rc.2',	// Minimum update manager version (soft limit).
				'check_hours' => array(
					24  => 'Every day',
					48  => 'Every two days',
					72  => 'Every three days',
