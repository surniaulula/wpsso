		...
		public static $cf = array(
			...
			'plugin' => array(
				...
				'wpssojson' => array(			// Plugin acronym.
					...
					'desc'        => 'Schema JSON-LD and Google Rich Results with Structured Data for Articles, Events, Images, Local Business, Products, Recipes, Reviews Videos, and more.',
			 ...
			 */
			'um' => array(
				'rec_version' => '2.3.0',	// Minimum update manager version (soft limit).
				'check_hours' => array(
					24  => 'Every day',
					48  => 'Every two days',
					72  => 'Every three days',
			...
			'wp' => array(
				...
				'rec_version' => '5.2.4',	// Soft limit - issue warning if lower version found.
