	...
	class WpssoAdminHeadSuggestAddons {
		...
		private function suggest_addons_wp_sitemaps() {
			...
			if ( $this->p->notice->is_admin_pre_notices( $notice_key ) ) {
				...
				$notice_msg .= __( 'You can activate this add-on to manage post and taxonomy types included in the sitemaps XML, exclude posts, pages, custom post types, taxonomy terms (categories, tags, etc.), and/or user profiles, and enhance the sitemaps XML with article modification times, images sitemaps, news sitemaps and more.', 'wpsso' );
