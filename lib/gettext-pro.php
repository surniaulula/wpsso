...
_x( 'Use WP Locale for Language', 'option label', 'wpsso' );
...
_x( 'seconds (0 to disable)', 'option comment', 'wpsso' );
_x( 'Get Shortened URL Cache Expiry', 'option label', 'wpsso' );
_x( 'seconds (0 to disable)', 'option comment', 'wpsso' );
_x( 'Get Image URL Info Cache Expiry', 'option label', 'wpsso' );
_x( 'seconds (0 to disable)', 'option comment', 'wpsso' );
