...
_x( 'recommended', 'option comment', 'wpsso' );
_x( 'Media Library Image Upscaling', 'option label', 'wpsso' );
_x( 'Maximum Image Upscale Percent', 'option label', 'wpsso' );
_x( 'Product Attribute Names', 'metabox title', 'wpsso' );
...
_x( 'Custom Field Names', 'metabox title', 'wpsso' );
...
__( 'Option disabled ("%1$s" head tag disabled or SEO plugin detected).', 'wpsso' );
...
_x( 'Twitter Card Desc', 'option label', 'wpsso' );
