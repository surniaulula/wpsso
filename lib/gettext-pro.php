...
_x( 'note that video preview images are included first', 'option comment', 'wpsso' );
...
_x( 'Pinterest Image Description', 'option label', 'wpsso' );
...
_x( 'Schema Markup and Structured Data', 'metabox title', 'wpsso' );
__( 'Save a draft version or publish the %s to display these options.', 'wpsso' );
_x( 'Facebook / Open Graph and Default Media', 'metabox title', 'wpsso' );
...
__( 'Yotpo for WooCommerce %1$s function returned false.', 'wpsso' );
__( '"%1$s" plugin not found in the WPMU_PLUGIN_DIR or WP_PLUGIN_DIR folders.', 'wpsso' );
__( 'Yotpo for WooCommerce API library file "%1$s" not found.', 'wpsso' );
__( 'Yotpo for WooCommerce "%1$s" class does not exist.', 'wpsso' );
