...
if ( ! class_exists( 'WpssoSubmenuAdvanced' ) && class_exists( 'WpssoAdmin' ) ) {
	...
	class WpssoSubmenuAdvanced extends WpssoAdmin {
		...
		protected function add_meta_boxes() {
			...
			add_meta_box( $this->pagehook . '_' . $metabox_id, $metabox_title,
				array( $this, 'show_metabox_edit' ), $metabox_screen,
					$metabox_context, $metabox_prio, $callback_args );
			...
			add_meta_box( $this->pagehook . '_' . $metabox_id, $metabox_title,
				array( $this, 'show_metabox_types' ), $metabox_screen,
					$metabox_context, $metabox_prio, $callback_args );
			...
			/**
			 * Head HTML Tags metabox.
			 */
			$metabox_id      = 'head_tags';
			$metabox_title   = _x( 'Head HTML Tags', 'metabox title', 'wpsso' );
			$metabox_screen  = $this->pagehook;
			$metabox_context = 'normal';
			$metabox_prio    = 'default';
			$callback_args   = array(	// Second argument passed to the callback function / method.
