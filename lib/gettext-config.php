...
_x( 'Advanced Settings Filters', 'lib file description', 'wpsso' );
_x( 'General Settings Filters', 'lib file description', 'wpsso' );
_x( 'Edit Metabox Filters', 'lib file description', 'wpsso' );
...
_x( '(api) URL Shortening Service', 'lib file description', 'wpsso' );
