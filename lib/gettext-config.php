...
_x( 'SSO Complementary Add-ons', 'lib file description', 'wpsso' );
...
_x( 'WPSSO Core add-on provides ratings and reviews for WordPress comments with Aggregate Rating meta tags and Schema Review markup.', 'plugin description', 'wpsso' );
...
_x( 'WPSSO Core add-on to remove outdated / incomplete Schema Microdata to use Google\'s preferred Schema JSON-LD for SEO Rich Results.', 'plugin description', 'wpsso' );
...
_x( 'WPSSO Core add-on to sharpen and improve WordPress thumbnails and resized images for social sharing and SEO.', 'plugin description', 'wpsso' );
