...
_x( 'Provides Google Rich Results and Structured Data for Articles, Carousels (aka ItemList), Claim Reviews, Events, FAQ Pages, How-Tos, Images, Local Business / Local SEO, Organizations, Products, Ratings, Recipes, Restaurants, Reviews, Videos, and more.', 'plugin description', 'wpsso' );
...
_x( 'Product Brand Attribute Name', 'option label', 'wpsso' );
_x( 'Product Color Attribute Name', 'option label', 'wpsso' );
_x( 'Product Condition Attribute Name', 'option label', 'wpsso' );
_x( 'Product Depth Attribute Name', 'option label', 'wpsso' );
_x( 'Product GTIN-14 Attribute Name', 'option label', 'wpsso' );
_x( 'Product GTIN-13/EAN Attribute Name', 'option label', 'wpsso' );
_x( 'Product GTIN-12/UPC Attribute Name', 'option label', 'wpsso' );
_x( 'Product GTIN-8 Attribute Name', 'option label', 'wpsso' );
_x( 'Product GTIN Attribute Name', 'option label', 'wpsso' );
_x( 'Product ISBN Attribute Name', 'option label', 'wpsso' );
_x( 'Product Material Attribute Name', 'option label', 'wpsso' );
_x( 'Product MPN Attribute Name', 'option label', 'wpsso' );
_x( 'Product Size Attribute Name', 'option label', 'wpsso' );
_x( 'Product Target Gender Attr. Name', 'option label', 'wpsso' );
_x( 'Product Volume Attribute Name', 'option label', 'wpsso' );
_x( '[None]', 'option value', 'wpsso' );
