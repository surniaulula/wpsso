...
_x( 'GTIN, GTIN-8, GTIN-12 (UPC), GTIN-13 (EAN), GTIN-14, ISBN, MPN, Depth (cm), and Volume (ml) for WooCommerce Products and Variations.', 'plugin description', 'wpsso' );
...
_x( 'Volume Attribute Name', 'option label', 'wpsso' );
_x( '[None]', 'option value', 'wpsso' );
