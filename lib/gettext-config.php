...
_x( 'WPSSO Core is fast, simple, and makes sure your content looks great on all social and search sites - no matter how your URLs are crawled, shared, re-shared, posted, or embedded!', 'plugin description', 'wpsso' );
...
_x( 'Schema JSON-LD markup and Google SEO Rich Results for Articles, Events, Local Business, Products, Recipes, Reviews and many more.', 'plugin description', 'wpsso' );
