...
_x( 'Complementary Add-ons', 'lib file description', 'wpsso' );
_x( 'Premium Licenses', 'lib file description', 'wpsso' );
_x( 'Makes sure your content looks great on all social and search sites - no matter how your URLs are crawled, shared, re-shared, posted, or embedded.', 'plugin description', 'wpsso' );
