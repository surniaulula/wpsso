...
_x( 'SSO Add-ons', 'lib file description', 'wpsso' );
...
_x( 'facebook', 'search term', 'wpsso' );
_x( 'google', 'search term', 'wpsso' );
_x( 'linkedin', 'search term', 'wpsso' );
_x( 'meta tag', 'search term', 'wpsso' );
