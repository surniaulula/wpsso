...
_x( 'Product Depth (cm) Custom Field', 'option label', 'wpsso' );
...
_x( 'Product Height (cm) Custom Field', 'option label', 'wpsso' );
_x( 'Product ISBN Custom Field', 'option label', 'wpsso' );
_x( 'Product Length (cm) Custom Field', 'option label', 'wpsso' );
...
_x( 'Product Volume (ml) Custom Field', 'option label', 'wpsso' );
_x( 'Product Weight (kg) Custom Field', 'option label', 'wpsso' );
_x( 'Product Width (cm) Custom Field', 'option label', 'wpsso' );
...
_x( 'Product Volume (ml) Attribute Name', 'option value', 'wpsso' );
_x( '[None]', 'option value', 'wpsso' );
