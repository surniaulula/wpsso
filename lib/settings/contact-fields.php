...
if ( ! class_exists( 'WpssoSettingsContactfields' ) && class_exists( 'WpssoAdmin' ) ) {

	class WpssoSettingsContactfields extends WpssoSubmenuAdvanced {
		...
		protected function add_meta_boxes() {
			...
			$metabox_title   = _x( 'User Profile Contact Fields', 'metabox title', 'wpsso' );
