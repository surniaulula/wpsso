			 ...
			 */
				...
				if ( strpos( $idx, 'info-meta-' ) === 0 ) {
					...
					switch ( $idx ) {
						...
						case 'info-plugin-tid':	// Displayed in the Pro and Add-ons settings page.
						...
						case 'info-plugin-tid-network':	// Displayed in the Network Pro and Add-ons settings page.
