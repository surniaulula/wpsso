			 ...
			 */
				...
				if ( strpos( $idx, 'info-meta-' ) === 0 ) {
					...
					switch ( $idx ) {
						...
						case 'info-plugin-tid':	// Displayed in the Add-ons settings page.
						...
						case 'info-plugin-tid-network':	// Displayed in the Network Add-ons settings page.
			 ...
			 */
				...
				switch ( $idx ) {
					...
					case 'pro-option-msg':
						...
						$text .= sprintf( _x( '[option preview] %s required', 'option comment', 'wpsso' ), $info['short_pro'] );
