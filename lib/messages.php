			 ...
			 */
				...
				switch ( $idx ) {
					...
					case 'notice-header-tmpl-default-head':
						...
						$text = '<p><b>'.__( 'Your header.php theme template does not support Schema markup of webpage headers.', 'wpsso' ).'</b> '.sprintf( __( 'The %s element in your header.php theme template should include a filter function call for its attributes.', 'wpsso' ), '<code>&lt;head&gt;</code>' ).' '.sprintf( __( '%1$s can update the header.php theme template automatically for you to change the default %2$s element to: %3$s', 'wpsso' ), $atts['short'], '<code>&lt;head&gt;</code>', '<pre><code>&lt;head &lt;?php echo apply_filters( \'head_attributes\', \'\' ); ?&gt;&gt;</code></pre>' ).'</p><p>'.sprintf( __( '<b><a href="%1$s">Click here to update the header.php theme template automatically</a></b> &mdash; or <a href="%2$s">modify the template yourself using the WordPress editor</a>.', 'wpsso' ), $update_url, $edit_url ).'</p>';
						break;
