				...
				if ( strpos( $msg_key, 'info-meta-' ) === 0 ) {
					...
					switch ( $msg_key ) {
						...
						case 'info-head_tags':
							...
							$text .= sprintf( __( '%s adds the following Facebook, Open Graph, Twitter, Schema, Pinterest, and Google SEO meta tags to the <code>&lt;head&gt;</code> section of your webpages.', 'wpsso' ), $info[ 'short' ] ) . ' ';
