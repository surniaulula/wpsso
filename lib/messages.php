			 ...
			 */
				...
				switch ( $msg_key ) {
					...
					case 'column-purchase-wpsso':
						...
						$text .= '<li><strong>' . __( 'Fetches data from active plugins and service APIs.', 'wpsso' ) . '</strong></li>';

						$text .= '<li><strong>' . __( 'Imports pre-existing plugin metadata and block attributes.', 'wpsso' ) . '</strong></li>';
