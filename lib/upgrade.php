	...
	class WpssoUpgrade {
		...
		private static $rename_options = array(
			'wpsso' => array(	// WPSSO Core plugin.
				...
				935 => array(	// Renamed for WPSSO Core v14.0.0.
					'plugin_attr_product_adult_oriented' => 'plugin_attr_product_adult_type',
					'plugin_attr_product_size_type'      => 'plugin_attr_product_size_group',
					'plugin_cf_product_adult_oriented'   => 'plugin_cf_product_adult_type',
					'plugin_cf_product_size_type'        => 'plugin_cf_product_size_group',
					'schema_def_product_adult_oriented'  => 'schema_def_product_adult_type',
				),
				941 => array(	// Renamed for WPSSO Core v14.2.0.
					'og_def_img_id_lib'     => '',
				...
				1020 => array(
					'plugin_wpssoam_tid'        => '',
					'plugin_wpssojson_tid'      => '',
					'plugin_wpssoorg_tid'       => '',
					'plugin_wpssoplm_tid'       => '',
					'plugin_wpssorrssb_tid'     => '',
					'plugin_wpssotie_tid'       => '',
					'plugin_wpsso_version'      => '',
					'plugin_wpssoafs_version'   => '',
					'plugin_wpssoam_version'    => '',
					'plugin_wpssobc_version'    => '',
					'plugin_wpssofaq_version'   => '',
					'plugin_wpssogmf_version'   => '',
					'plugin_wpssoipm_version'   => '',
					'plugin_wpssojson_version'  => '',
					'plugin_wpssoopm_version'   => '',
					'plugin_wpssoorg_version'   => '',
					'plugin_wpssoplm_version'   => '',
					'plugin_wpssorar_version'   => '',
					'plugin_wpssorest_version'  => '',
					'plugin_wpssorrssb_version' => '',
					'plugin_wpssossc_version'   => '',
					'plugin_wpssossm_version'   => '',
					'plugin_wpssotie_version'   => '',
					'plugin_wpssoul_version'    => '',
					'plugin_wpssoum_version'    => '',
					'plugin_wpssowcmd_version'  => '',
					'plugin_wpssowcsdt_version' => '',
					'plugin_wpssowpsm_version'  => '',
				),
				1027 => array(
					'plugin_og_type_col_attachment'               => '',
					'plugin_og_type_col_download'                 => '',
					'plugin_og_type_col_page'                     => '',
					'plugin_og_type_col_post'                     => '',
					'plugin_og_type_col_product'                  => '',
					'plugin_og_type_col_tax_category'             => '',
					'plugin_og_type_col_tax_faq_category'         => '',
					'plugin_og_type_col_tax_link_category'        => '',
					'plugin_og_type_col_tax_post_tag'             => '',
					'plugin_og_type_col_tax_product_cat'          => '',
					'plugin_og_type_col_tax_product_tag'          => '',
					'plugin_og_type_col_tax_tribe_events_cat'     => '',
					'plugin_og_type_col_user_page'                => '',
					'plugin_schema_type_col_attachment'           => '',
					'plugin_schema_type_col_download'             => '',
					'plugin_schema_type_col_page'                 => '',
					'plugin_schema_type_col_post'                 => '',
					'plugin_schema_type_col_product'              => '',
					'plugin_schema_type_col_tax_category'         => '',
					'plugin_schema_type_col_tax_faq_category'     => '',
					'plugin_schema_type_col_tax_link_category'    => '',
					'plugin_schema_type_col_tax_post_tag'         => '',
					'plugin_schema_type_col_tax_product_cat'      => '',
		...
		public function options( $opts_name, $opts = array(), $defs = array(), $network = false ) {
			...
			foreach ( array(
				...
				'schema_def_service_prov_org_id'       => 'org',
				...
				'schema_def_service_prov_person_id'    => 'person',
