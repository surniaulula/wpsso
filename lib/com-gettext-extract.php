...
__( 'Please contact the author of that filter hook and report this issue as a coding error / bug.', wpsso );
__( 'Please contact your hosting provider to have this feature disabled or install a newer version of PHP.', wpsso );
__( 'Please contact your hosting provider to have this setting disabled.', wpsso );
__( 'Reference URL: %s', wpsso );
...
__( 'The PHP "%s" feature is enabled &mdash; the PHP cURL library cannot follow URL redirects.', wpsso );
__( 'The PHP "%s" setting is defined &mdash; the PHP cURL library cannot follow URL redirects.', wpsso );
__( 'The "%s" feature is deprecated since PHP version 5.3 and removed from PHP since version 5.4.', wpsso );
