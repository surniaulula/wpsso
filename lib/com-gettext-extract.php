...
__( 'All WordPress filter hooks must return their data / text and not send it to the output.', wpsso );
__( '---BEGIN---', wpsso );
...
__( 'Incorrect data / text output:', wpsso );
__( 'Notice', wpsso );
__( 'PHP cURL library is missing &mdash; contact your hosting provider to have the cURL library installed.', wpsso );
__( 'PHP "safe_mode" or "open_basedir" is defined &mdash; the PHP cURL library cannot follow URL redirects.', wpsso );
__( 'Please contact the author of that filter hook and report this as a coding error / bug.', wpsso );
__( 'Reference URL: %s', wpsso );
__( 'Requests to cache this URL will be ignored for %d second(s).', wpsso );
__( '%s Notice', wpsso );
__( 'The "%1$s" filter hook with priority %2$d in the "%3$s" filter has mistakenly provided some output.', wpsso );
