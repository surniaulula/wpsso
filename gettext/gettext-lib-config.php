...
_x( '(api) Facebook Videos API', 'lib file description', 'wpsso' );
_x( '(api) Gravatar Images API', 'lib file description', 'wpsso' );
_x( '(api) Slideshare Presentations API', 'lib file description', 'wpsso' );
_x( '(api) Soundcloud Tracks API', 'lib file description', 'wpsso' );
_x( '(feature) Upscale Media Library Images', 'lib file description', 'wpsso' );
_x( '(api) Vimeo Videos API', 'lib file description', 'wpsso' );
_x( '(api) Wistia Videos API', 'lib file description', 'wpsso' );
_x( '(api) WordPress Video Shortcodes API', 'lib file description', 'wpsso' );
