...
_x( 'Product Net Depth Custom Field', 'option label', 'wpsso' );
_x( 'Product Net Fl. Volume Custom Field', 'option label', 'wpsso' );
...
_x( 'Net Depth Attribute Name', 'option label', 'wpsso' );
_x( 'Net Fl. Volume Attribute Name', 'option label', 'wpsso' );
