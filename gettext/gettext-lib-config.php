...
_x( 'WPSSO Core', 'plugin name', 'wpsso' );
_x( 'Present your content at its best on social sites and search results - no matter how URLs are shared, reshared, messaged, posted, embedded, or crawled.', 'plugin description', 'wpsso' );
