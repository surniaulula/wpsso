...
_x( 'Adult Type Attribute Name', 'option label', 'wpsso' );
...
_x( 'Energy Rating Attribute Name', 'option label', 'wpsso' );
...
_x( 'Net Height Attribute Name', 'option label', 'wpsso' );
_x( 'ISBN Attribute Name', 'option label', 'wpsso' );
_x( 'Net Length / Depth Attribute Name', 'option label', 'wpsso' );
...
_x( 'Size Group Attribute Name', 'option label', 'wpsso' );
_x( 'Size System Attribute Name', 'option label', 'wpsso' );
_x( 'Target Gender Attribute Name', 'option label', 'wpsso' );
_x( 'Net Weight Attribute Name', 'option label', 'wpsso' );
_x( 'Net Width Attribute Name', 'option label', 'wpsso' );
_x( '[None]', 'option value', 'wpsso' );
