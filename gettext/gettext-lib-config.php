...
_x( 'Manage Schema Places and Local SEO for Facebook / Open Graph, Pinterest, and Google Local Business.', 'plugin description', 'wpsso' );
...
_x( 'Manage post and taxonomy types included in the WordPress sitemaps XML, and exclude any "No Index" content.', 'plugin description', 'wpsso' );
...
_x( 'Open Graph', 'column header', 'wpsso' );
