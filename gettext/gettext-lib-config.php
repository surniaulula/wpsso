...
_x( '(api) Get WordPress Video Block Data', 'lib file description', 'wpsso' );
_x( '(api) Get WordPress Video Shortcode Data', 'lib file description', 'wpsso' );
...
_x( 'WordPress Video Blocks', 'option value', 'wpsso' );
_x( 'WordPress Video Shortcodes', 'option value', 'wpsso' );
