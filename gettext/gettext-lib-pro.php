...
_x( 'recommended if using shortcodes in excerpts', 'option comment', 'wpsso' );
...
_x( 'seconds (0 to disable)', 'option comment', 'wpsso' );
_x( 'API Response Cache Expiry', 'option label', 'wpsso' );
_x( 'seconds (0 to disable)', 'option comment', 'wpsso' );
_x( 'Short URL Cache Expiry', 'option label', 'wpsso' );
_x( 'seconds (0 to disable)', 'option comment', 'wpsso' );
_x( 'Schema Index Cache Expiry', 'option label', 'wpsso' );
_x( 'seconds (0 to disable)', 'option comment', 'wpsso' );
_x( 'Form Selects Cache Expiry', 'option label', 'wpsso' );
_x( 'seconds (0 to disable)', 'option comment', 'wpsso' );
_x( 'Cache Attachment Markup', 'option label', 'wpsso' );
_x( 'Cache Date Archive Markup', 'option label', 'wpsso' );
