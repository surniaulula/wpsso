...
_x( 'Post Type Archives', 'metabox title', 'wpsso' );
_x( '%s Archive Title', 'option label', 'wpsso' );
_x( '%s Archive Description', 'option label', 'wpsso' );
...
_x( 'Schema Review Subject Information', 'metabox title', 'wpsso' );
...
_x( 'Schema Product Information', 'metabox title', 'wpsso' );
