...
_x( 'Author Type', 'option label', 'wpsso' );
_x( 'Author Name', 'option label', 'wpsso' );
_x( 'Author URL', 'option label', 'wpsso' );
_x( 'Published Date', 'option label', 'wpsso' );
_x( 'Created Date', 'option label', 'wpsso' );
