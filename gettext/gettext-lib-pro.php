...
_x( 'Show Metadata Import Details', 'option label', 'wpsso' );
...
__( 'No priority media options for the %s.', 'wpsso' );
_x( 'Image ID', 'option label', 'wpsso' );
_x( 'or an Image URL', 'option label', 'wpsso' );
_x( 'Schema JSON-LD Markup / Google Rich Results', 'metabox title', 'wpsso' );
_x( 'Image ID', 'option label', 'wpsso' );
...
__( 'Imported %1$s "%2$s" metadata from post ID %3$d.', 'wpsso' );
__( 'Imported %1$s "%2$s" metadata from term ID %3$d.', 'wpsso' );
__( 'Imported %1$s "%2$s" metadata from user ID %3$d.', 'wpsso' );
