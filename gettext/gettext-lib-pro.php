...
_x( 'Default Attendance', 'option label', 'wpsso' );
...
_x( 'Default Product Adult Oriented', 'option label', 'wpsso' );
...
_x( 'Schema Creative Work Information', 'metabox title', 'wpsso' );
_x( 'Is Part of URLs', 'option label', 'wpsso' );
_x( 'Headline', 'option label', 'wpsso' );
_x( 'Full Text', 'option label', 'wpsso' );
_x( 'Keywords', 'option label', 'wpsso' );
_x( 'Language', 'option label', 'wpsso' );
_x( 'Family Friendly', 'option label', 'wpsso' );
_x( 'Copyright Year', 'option label', 'wpsso' );
_x( 'License URL', 'option label', 'wpsso' );
_x( 'Publisher Org.', 'option label', 'wpsso' );
_x( 'Publisher Person', 'option label', 'wpsso' );
_x( 'Service Prov. Org.', 'option label', 'wpsso' );
_x( 'Service Prov. Person', 'option label', 'wpsso' );
_x( 'Schema Article Information', 'metabox title', 'wpsso' );
_x( 'Article Section', 'option label', 'wpsso' );
_x( 'Est. Reading Time', 'option label', 'wpsso' );
__( 'minute(s)', 'wpsso' );
...
_x( 'Schema How-To Information', 'metabox title', 'wpsso' );
_x( 'How-To Makes', 'option label', 'wpsso' );
_x( 'Preparation Time', 'option label', 'wpsso' );
_x( 'Total Time', 'option label', 'wpsso' );
_x( 'How-To Supplies', 'option label', 'wpsso' );
_x( 'How-To Tools', 'option label', 'wpsso' );
_x( 'How-To Steps', 'option label', 'wpsso' );
_x( '%1$s How-To Step or %2$s Step Group / Section:', 'option label', 'wpsso' );
_x( 'Name', 'option label', 'wpsso' );
_x( 'Description', 'option label', 'wpsso' );
_x( 'Image ID', 'option label', 'wpsso' );
_x( 'Schema Recipe Information', 'metabox title', 'wpsso' );
_x( 'Recipe Cuisine', 'option label', 'wpsso' );
_x( 'Recipe Course', 'option label', 'wpsso' );
_x( 'Recipe Makes', 'option label', 'wpsso' );
_x( 'Cooking Method', 'option label', 'wpsso' );
_x( 'Preparation Time', 'option label', 'wpsso' );
_x( 'Cooking Time', 'option label', 'wpsso' );
_x( 'Total Time', 'option label', 'wpsso' );
_x( 'Recipe Ingredients', 'option label', 'wpsso' );
_x( 'Recipe Instructions', 'option label', 'wpsso' );
_x( '%1$s Recipe Instruction or %2$s Instruction Group / Section:', 'option label', 'wpsso' );
_x( 'Name', 'option label', 'wpsso' );
_x( 'Description', 'option label', 'wpsso' );
_x( 'Image ID', 'option label', 'wpsso' );
_x( 'Schema Recipe Nutrition Information', 'metabox title', 'wpsso' );
_x( 'Serving Size', 'option label', 'wpsso' );
_x( 'Calories', 'option label', 'wpsso' );
_x( 'calories', 'option comment', 'wpsso' );
_x( 'Protein', 'option label', 'wpsso' );
_x( 'grams of protein', 'option comment', 'wpsso' );
_x( 'Fiber', 'option label', 'wpsso' );
_x( 'grams of fiber', 'option comment', 'wpsso' );
_x( 'Carbohydrates', 'option label', 'wpsso' );
_x( 'grams of carbohydrates', 'option comment', 'wpsso' );
_x( 'Sugar', 'option label', 'wpsso' );
_x( 'grams of sugar', 'option comment', 'wpsso' );
_x( 'Sodium', 'option label', 'wpsso' );
_x( 'milligrams of sodium', 'option comment', 'wpsso' );
_x( 'Fat', 'option label', 'wpsso' );
_x( 'grams of fat', 'option comment', 'wpsso' );
_x( 'Saturated Fat', 'option label', 'wpsso' );
_x( 'grams of saturated fat', 'option comment', 'wpsso' );
_x( 'Unsaturated Fat', 'option label', 'wpsso' );
_x( 'grams of unsaturated fat', 'option comment', 'wpsso' );
_x( 'Trans Fat', 'option label', 'wpsso' );
_x( 'grams of trans fat', 'option comment', 'wpsso' );
_x( 'Cholesterol', 'option label', 'wpsso' );
...
_x( 'Event Physical Venue', 'option label', 'wpsso' );
