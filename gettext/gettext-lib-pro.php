...
_x( 'Type for Search Results', 'option label', 'wpsso' );
_x( 'Type for Archive Page', 'option label', 'wpsso' );
_x( 'Type for Media Audio', 'option label', 'wpsso' );
_x( 'Type for Media Image', 'option label', 'wpsso' );
_x( 'Type for Media Video', 'option label', 'wpsso' );
_x( 'for %s', 'option comment', 'wpsso' );
_x( 'Type by Post Type', 'option label', 'wpsso' );
_x( 'for %s', 'option comment', 'wpsso' );
_x( 'Type by Post Type Archive', 'option label', 'wpsso' );
...
_x( 'Add Text or Article Body Property', 'option label', 'wpsso' );
...
_x( 'Claim Review Information', 'metabox title', 'wpsso' );
_x( 'Short Summary of Claim', 'option label', 'wpsso' );
_x( 'First Appearance URL', 'option label', 'wpsso' );
_x( 'Software App Information', 'metabox title', 'wpsso' );
_x( 'Operating System', 'option label', 'wpsso' );
_x( 'Application Category', 'option label', 'wpsso' );
...
_x( 'Funder Org.', 'option label', 'wpsso' );
_x( 'Funder Person', 'option label', 'wpsso' );
...
_x( 'Product Information (Main Product)', 'metabox title', 'wpsso' );
