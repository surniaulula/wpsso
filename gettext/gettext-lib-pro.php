...
__( 'Ow.ly shortener API error: %s', 'wpsso' );
__( 'Invalid response received.', 'wpsso' );
__( 'Ow.ly shortener API error: %s', 'wpsso' );
__( 'Ow.ly shortener API error: %s', 'wpsso' );
__( 'Invalid request method.', 'wpsso' );
__( 'Ow.ly shortener API error: %s', 'wpsso' );
__( 'TinyURL shortener API error: %s', 'wpsso' );
__( 'TinyURL shortener API error: %s', 'wpsso' );
__( 'YOURLS shortener API error: %s', 'wpsso' );
__( 'YOURLS shortener API error: %s', 'wpsso' );
__( 'JSON response decode error (%d).', 'wpsso' );
__( 'YOURLS shortener API error: %s', 'wpsso' );
__( 'DLMY.App shortener API error: %s', 'wpsso' );
__( 'DLMY.App shortener API error: %s', 'wpsso' );
__( 'JSON response decode error (%d).', 'wpsso' );
__( 'DLMY.App shortener API error: %s', 'wpsso' );
...
__( 'Group name "%s" not found in the Bitly groups.', 'wpsso' );
