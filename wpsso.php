 ...
 * Description: Rank higher and increase click-through-rates by presenting your content at its best on social sites and in search results - no matter how webpages are shared, re-shared, messaged, posted, embedded, or crawled.
 * Requires PHP: 7.0
 * Requires At Least: 4.5
 * Tested Up To: 5.7.2
 * WC Tested Up To: 5.4.1
 * Version: 8.31.0-dev.2
 *
...
if ( ! class_exists( 'Wpsso' ) ) {
	...
	class Wpsso {
		...
		public function set_objects( $activate = false ) {
			 ...
			 * $doing_ajax and $doing_cron added in WPSSO Core v8.8.0.
			 */
